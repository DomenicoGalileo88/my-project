        ...
        >
          <div class="container">
            ...
            <div class="row">
              ...
              <div
                class="boolean col-11 d-flex justify-content-center align-items-center"
              >
              ...
              <div
                class="malvin col-11 d-flex justify-content-center align-items-center"
              >
                <div class="text_experience">
                  ...
                  <p>
                    ...
                    sviluppare una grande attitudine al
                    <em>problem solving</em>, attraverso la pianificazione e
                    prontezza nello svolgimento delle mansioni di manutenzione
                    dell'impianto elettrico e la riparazione di macchinari per
                    le Aziende clienti. Il gruppo era alla base del lavoro che
                    si svolgeva, con la distribuzione dei vari ruoli si
                    cooperava per la produzione dei prodotti(premiscelati,
                    idropitture) e la manutenzione degli impianti di produzione.
                  </p>
                </div>
              </div>
              <!-- /.malvin -->
